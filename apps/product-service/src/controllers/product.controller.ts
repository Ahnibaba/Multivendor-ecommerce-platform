...
export const getShopProducts = async (
  ...
  try {
    ...
    console.log("Error in the getShopProducts", error);
...
export const getAllProduct = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    console.error("Error in the getAllProduct function", error);
    next(error)
  }
} 
// get All events
export const getAllEvents = async (req: Request, res: Response, next: NextFunction) => {
  try {
   ...
   const baseFilter = {
    ...
    const [events, total, top10Events] = await Promise.all([
      prisma.products.findMany({
        skip,
        take: limit,
        include: {
    ...
    console.error("Error in the getAllEvents function", error);
    next(error)
  }
} 
