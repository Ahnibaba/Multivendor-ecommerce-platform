            ...
            <div className="relative flex items-center justify-between md:w-[50%] mb-8">
                ...
                {[1, 2, 3].map((step) => (
                    <div key={step} className="">
                        <div className={`w-10 h-10 flex items-center justify-center rounded-full text-white font-bold ${step <= activeStep ? "bg-blue-600" : "bg-blue-300"
                            }`}
                        >
                            {step}
                        </div>
                    ...
                    <>
                        {!showOtp ? (
                            ...
                            >
                                ...
                                <input
                                    type="email"
                                    placeholder="aniebietedet2025@gmail.com"
                                    className="w-full p-2 border border-gray-300 outline-0 !rounded mb-1"
                                    {...register("email", {
                                ...
                                <div className="flex justify-center gap-6">
                                    {otp?.map((digit, index) => (
                                        <input
                                            ...
                                            maxLength={1}
                                            className={`w-12 h-12 text-center border border-gray-300 outline-none !rounded ${focus === index && "outline-2 outline-gray-900"}`}
                                            value={digit}
