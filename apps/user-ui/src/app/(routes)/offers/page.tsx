         ...
         <div className="w-[90%] lg:w-[80%] m-auto">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-8">
               ...
               <aside className="w-full lg:w-[270px] !rounded bg-white p-4 space-y-6 shadow-md">
                  <h3 className="text-xl font-Poppins font-medium">Offers Filter</h3>
                  <div className="ml-2">
                     <Range
                        step={1}
                        min={MIN}
                  ...
                  {/* Colors */}
                  <h3 className="text-xl font-Poppins font-medium border-b border-b-slate-300 pb-1 mt-4">
                     Filter by Color
                  </h3>
                  ...
                  {/* Sizes */}
                  <h3 className="text-xl font-Poppins font-medium border-b border-b-slate-300">
                     Filter by Size
                  </h3>
                  <ul className="space-y-2 !mt-3">
                     {sizes.map((size) => (
               ...
               {/* product grid */}
               <div className="flex-1 px-2 lg:px3">
                  {isProductLoading ? (
                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-2 space-y-1">
                  ...
                  products.length > 0 ? (
                    ...
                    !isProductLoading && products.length === 0 && <p className="">No Products found!</p>  
                  )
               )}
