                              ...
                              return (
                                 ...
                                 >
                                    <div className="flex items-center gap-3">
                                       <Image
                                          src={
                                             chat.seller?.avatar[0] || "https://ik.imagekit.io/shahriarbecodemy/avatar/6_t8b5y8t3U.png"
                                          }
                  ...
                  {selectedChat ? (
                     <>
                        <div className="p-4 border-b border-b-gray-200 bg-white flex items-center gap-3">
                           <Image
                              src={selectedChat.seller?.avatar[0] || "https://ik.imagekit.io/shahriarbecodemy/avatar/6_t8b5y8t3U.png"}
