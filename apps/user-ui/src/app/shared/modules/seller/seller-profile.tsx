...
import { Calendar, Globe, Heart, MapPin, PlayCircle, Star, Users, XIcon, YoutubeIcon } from "lucide-react"
       ...
       <div>
          ...
          <div className="w-[85%] lg:w-[70%] mt-[-50px] mx-auto relative z-20 flex flex-col lg:flex-row gap-6">
             <div className="bg-gray-200 p-6 rounded-lg shadow-lg flex-1">
                <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                    ...
                    <div className="flex-1 w-full">
                        <h1 className="text-2xl font-semibold text-slate-90">
                            {shop?.name}
                        </h1>
             ...
             <div className="bg-gray-200 p-6 rounded-lg shadow-lg w-full lg:w-[30%]">
                 ...
                 {shop?.socialLinks && shop?.socialLinks.lenth > 0 && (
                    <div className="mt-3">
