...
const ProductDetailsCard = ({ data, setOpen }: { data: any, setOpen: (open: boolean) => void }) => {
  ...
  return (
    ...
    >
      <div className="w-[90%] md:w-[70%] md:mt-14 2xl:mt-0 h-max overlow-scroll min-h-[70vh] p-4 md:p-6 bg-white shadow-md rounded-lg"
            ...
            <div className="flex gap-2 mt-4">
               {data?.images?.map((img: any, index: number) => (
                 ...
                 key={index}
                  ...
                  >
                    {/* "https://ik.imagekit.io/fz0xzwtey/products/product" */}
                    <Image
                      src={img?.url}
                      alt={`Thumbnail ${index}`}
                      width={80}
