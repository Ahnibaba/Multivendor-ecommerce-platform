...
const GoogleButton = ({ type }: {type: string}) => {
  return (
    <div className="w-full flex justify-center">
      <div className="h-[46px] cursor-pointer border border-blue-100 flex items-center px-3 rounded-md gap-2 my-2 bg-[rgba(210,227,252,0.3)]">
        <svg
        ...
        <span className="text-sm font-medium">{type} with Google</span>
      </div>
    </div>
  );
};
